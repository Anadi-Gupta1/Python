...
| 🔹 Program | ⚙️ Functionality | 📥 Input | 📤 Output |
|-----------|-----------------|----------|-----------|
...
| 🔹 Program | 🔄 Algorithm | ⏱️ Complexity | 🎯 Key Concept |
|-----------|-------------|---------------|----------------|
...
| 🔹 Program | ⚙️ Functionality | 🌟 Features | 🎯 Key Concepts |
|-----------|-----------------|-------------|-----------------|
...
2. **📂 Navigate to desired module:**
   ...
   cd 10_DSA                # 🗂️ For data structures & algorithms
   ```
